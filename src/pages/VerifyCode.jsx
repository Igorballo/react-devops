    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-8 px-2">
      <div className="rounded-3xl flex flex-col lg:flex-row w-full max-w-5xl overflow-hidden">
        ...
        <div className="lg:w-1/2 w-full flex flex-col justify-center px-20">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Vérifier le code</h2>
          <p className="text-gray-600 text-sm mb-6">
            Un code d'authentification a été envoyé à votre adresse e-mail.
          </p>
          <form>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Entrer le code <span className="text-red-500">*</span>
            </label>
            <div className="mb-2 relative">
              <input
                type="text"
                required
                placeholder="778-9BM-68X"
            ...
            <div className="flex justify-between items-center mb-4">
              <span className="text-xs text-gray-500">Vous n'avez pas reçu de code ?</span>
              <button type="button" className="text-xs text-blue-600 hover:underline font-medium">Renvoyer</button>
            </div>
