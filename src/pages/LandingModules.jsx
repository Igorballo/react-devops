...
const LandingModules = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-8 px-2">
      <div className="rounded-3xl flex flex-col lg:flex-row w-full max-w-7xl overflow-hidden lg:gap-8">
        {/* Image à gauche */}
        <div className="lg:w-4/12 w-full flex items-center justify-center bg-gray-100">
          <img src="/images/LOGIN.png" alt="Connexion" className="rounded-2xl object-cover w-full h-full" />
        </div>
        {/* Modules à droite */}
        <div className="lg:w-8/12 w-full flex flex-col items-center justify-center p-8">
          <div className="w-full ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 items-center justify-center gap-5">
              {modules.map((mod, idx) => (
                <Link
                  to={mod.to}
                  key={idx}
                ...
                >
                  {mod.logo ? (
                    <img src={mod.logo} alt={mod.name} className="h-14 w-ful mb-2" />
                  ) : (
                  ...
                  <span className="text-gray-600 text-xl mt-auto">&rarr;</span>
                </Link>
              ))}
            </div>
          </div>
